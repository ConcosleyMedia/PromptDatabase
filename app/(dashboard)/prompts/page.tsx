...
export default function TextPromptsPage() {
  ...
  const [filters, setFilters] = useState<PromptFiltersType>({ type: 'text' })
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Text Prompts</h1>
          <p className="text-muted-foreground">
            Discover and save text prompts for ChatGPT, Claude, and other AI models
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="flex items-center space-x-2 p-4 rounded-lg border">
          ...
          <div>
            ...
            <p className="font-medium">AI & Coding prompts</p>
          </div>
        </div>
        <div className="flex items-center space-x-2 p-4 rounded-lg border">
          ...
          <div>
            ...
            <p className="font-medium">{prompts.filter(p => {
